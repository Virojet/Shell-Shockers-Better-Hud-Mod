...
&nbsp;
[![Version](https://img.shields.io/badge/version-4.9.3-black?style=for-the-badge)](./Shell-Shockers-Better-Hud.user.js)
...
> [!IMPORTANT]
> Already on v4.8 or newer? Reload Shell Shockers and your userscript manager should detect v4.9.3 automatically. If it does not update, install once from the button above to refresh the update headers.
...
To check what's new later, click the **Shell Shockers Better HUD v4.9.3** text at the bottom of the mod settings panel to reopen the changelog and browse older releases.
