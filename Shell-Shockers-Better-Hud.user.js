...
(function () {
    ...
    (function installVersionChangelog() {
        ...
        const changelogItems = [
            ...
            { label: "Hide Scope Frame", text: "Hide Scope Frame is now disabled by default and command-only — enter \"hide scope frame\" in Import Settings Code to toggle it. It was removed as a settings option at the developers' request since it can give an unfair edge." },
