...
(function () {
    ...
    (function installVersionChangelog() {
        ...
        const changelogItems = [
            { label: "Match End", text: "When a match ends, the live scoreboard now holds the final kills / deaths instead of flashing to 0. It resets only when the next match actually starts, and no longer saves a blank duplicate match to Stats History." },
