...
(function () {
    ...
    (function installVersionChangelog() {
        ...
        // The changelog re-shows whenever this literal changes (independent of the
        // Tampermonkey @version header), so anyone on an earlier build sees the 4.9
        // notes automatically on their next load, then only again on the next bump.
        ...
        const changelogHistory = [
            { version: displayVersion, intro: "Here's what's new in this release:", items: changelogItems },
            {
                ...
                items: [
                    ...
                    { label: "Legacy", text: "Legacy Skins and Legacy Sounds toggles restore classic gun models and SFX live without a reload." },
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: "Legacy", text: "Legacy Skins and Legacy Sounds became live toggles." },
